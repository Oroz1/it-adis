    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='core.courses', verbose_name='Курс')),
                ('course_time', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='core.shiftsdays', verbose_name='Время курса')),
            ],
            options={
